...
public class B_B_interface extends JFrame {
    ...
    public B_B_interface(int numberOfDataCenters, int dataCenterIndex, List<B_A_interface.DataCenterData> centerDataList, int dataCenterNumber,int numberOfHosts, String systemArchitecture, String operatingSystem, String vmmName, double timeZone,
     ...
     // Store the parameters in the instance variables
        ...
        btnNewButton.setBounds(304, 434, 141, 35);
                    ...
                    try {
                       ...
                       // HostDataList.add(hostData);
                        ...
                        if (dataCenterIndex < numberOfDataCenters - 2) {
                            ...
                            B_B_interface datainter = new B_B_interface(numberOfDataCenters, dataCenterIndex + 1, centerDataList, dataCenterNumber + 1, Integer.parseInt(textField.getText()), txtX.getText(), txtLinux.getText(), txtXen.getText(),
