...
import thread.C_B_interface.HostData;
...
public class B_A_interface extends JFrame {
    ...
    public B_A_interface(int numberOfDataCenters) {
        ...
        lblNewLabel_9.setBounds(150, 422, 127, 25);
        ...
        rdbtnNewRadioButton.setBounds(301, 423, 142, 23);
        ...
        rdbtnNewRadioButton_1.setBounds(450, 424, 127, 23);
        ...
        lblNewLabel_8_1.setBounds(164, 394, 221, 25);
        ...
        textField_1.setBounds(410, 397, 101, 20);
                    ...
                    try {
                        if (rdbtnNewRadioButton.isSelected()) {
                            ...
                            for (int i = 0; i < numberOfDataCenters; i++) {
                                ...
                                centerData.sleep_time = Integer.parseInt(textField_1.getText());
                         ...
                         // Create a DataCenterData object for heterogeneous data center
							...
							if(numberOfDataCenters == 1) {
	                            ...
	                            B_B_interface datainter = new B_B_interface(numberOfDataCenters, dataCenterIndex, new ArrayList<>(), dataCenterNumber, Integer.parseInt(textField_1.getText()),Integer.parseInt(textField.getText()), txtX.getText(), txtLinux.getText(), txtXen.getText(),
     ...
     // Getter method for interhost
		...
		public static int getSleepTime() {
			// TODO Auto-generated method stub
			return DataCenterData.sleep_time;
		}
}
